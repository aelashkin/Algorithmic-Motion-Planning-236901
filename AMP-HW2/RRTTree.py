...
class RRTTree(object):
    ...
    def get_k_nearest_neighbors(self, state, k, k_type):
        '''
        ...
        # sorted_dists = np.argpartition(dists, kth=k, axis=-1)
        # print("sorted_dists is:", sorted_dists, type(sorted_dists))
        # knn_ids = sorted_dists[:k]
